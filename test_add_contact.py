...
class test_add_contact(unittest.TestCase):
    ...
    def test_create_contact(self):
        ...
        self.login(wd)
        self.create_contact(wd, Contact(firstname="Name", middlename="Middle name", lastname="Last name",
                       nickname="Nickname", title="Title", company="Company", address="Address", home="6666666",
                       mobile="555555", work="444444", fax="1111", email="email1", email2="email2", email3="email3",
                       homepage="www.homapage.com", bday="1", bmonth="March", byear="1856", aday="2", amonth="May",
